...
This repository contains the source code for the Flui3d Chat, a language-driven online design platform for microfluidics. It consists of a user interface and core services, including an LLM for design generation, validation, and correction logic, as well as a synthesis tool for generating chip layouts.
...
The primary configuration is managed in the `Backend/src/main/resources/application.properties` file. Make sure the values match your setup.
